...
public class LockPatternIndicator extends View {
    ...
    public LockPatternIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.LockPatternIndicator, defStyleAttr, 0);

        mDefaultColor = a.getColor(R.styleable.LockPatternIndicator_idc_default_color, getResources().getColor(R.color.gesture_default_color));
        mSelectorColor = a.getColor(R.styleable.LockPatternIndicator_idc_selector_color, getResources().getColor(R.color.gesture_primary_color));
